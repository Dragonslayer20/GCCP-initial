            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-links ">
                        <h4>Placements</h4>
                        <ul>
                            <li><i class="bx bx-chevron-right "></i> <a href="# ">Oracle Developer</a></li>
                            <li><i class="bx bx-chevron-right "></i><a href="# ">Node JS Developer</a></li>
                            <li><i class="bx bx-chevron-right "></i> <a href="# ">Php Developer</a></li>
